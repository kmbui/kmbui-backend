...
CREATE TABLE `__new_admin_users` (
	...
	`updated_at` integer,
	`created_at` integer DEFAULT '"2025-09-05T09:51:46.823Z"' NOT NULL,
	`deleted_at` integer
);
...
CREATE TABLE `__new_key_usage_logs` (
	...
	`timestamp` integer DEFAULT '"2025-09-05T09:51:46.824Z"' NOT NULL,
	`api_user_id` text,
	`admin_user_id` text,
...
ALTER TABLE `__new_key_usage_logs` RENAME TO `key_usage_logs`;--> statement-breakpoint
